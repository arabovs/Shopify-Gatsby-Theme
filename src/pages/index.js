    ...
    <Box>
      ...
      <Box py={4} textAlign="center">
        ...
        <Typography
          ...
          paragraph
        >
          Welcome to our exquisite night lounge clothing company, nestled in the
          heart of Bulgaria, where we craft the epitome of sophistication and
          luxury. At our establishment, we specialize in creating bespoke night
          lounge attire that exudes unparalleled opulence and exclusivity. Each
          piece of clothing is meticulously designed to reflect your unique
          style and preferences, ensuring you step into your evenings with an
          aura of sophistication. Our dedication to excellence is mirrored in
          our choice of the finest fabrics, sourced from across the globe, and
          our commitment to impeccable craftsmanship. Explore our exclusive
          range of elegantly tailored garments and experience the epitome of
          posh, bespoke elegance. Discover the allure of handcrafted elegance at
          its finest and elevate your nights with our extraordinary creations.
        </Typography>
      </Box>
        ...
        {showCollection1 ? (
          <Box py={4} textAlign="center">
            ...
            >
              ...
              indulge in a cozy night at home, our carefully curated pieces will
              make you feel like you've arrived in your personal haven. From
              sumptuously soft loungewear sets to silky nightgowns, each garment
              in this collection is an invitation to embrace tranquility and
              savor the sweet moments of being home. Explore "Honey, I'm Home!"
              and elevate your evenings with a touch of luxury.
            </Typography>
        ...
        {showCollection2 ? (
          <Box py={4} textAlign="center">
            ...
            >
              ...
              both, our bundles cater to your individual tastes. Experience the
              effortless luxury of complete outfits that reflect your
              personality and provide unparalleled ease in dressing. Elevate
              your wardrobe with our top-to-bottom bespoke bundles and set a new
              standard for personalized fashion.
            </Typography>
            <Grid container spacing={3}>
        ...
        {showCollection3 ? (
          <Box py={4} textAlign="center">
            ...
            >
              ...
              strolling through the city or attending a social event, our pieces
              are your canvas, allowing you to paint your own narrative with
              style and panache. Discover a world of sartorial creativity and
              become a living work of art with our "Walking Art – Out and about"
              collection.
            </Typography>
            <Grid container spacing={3}>
              {filteredCollection1?.map((product, index) => (
